...
// NIGHTMARE FUEL (by Park Loqi. You're welcome.)
// Open a console in Chrome and see what happens when you manually type each line below.
// You know you're a nerd if you actually laugh at the funny ones and a super-nerd if you
// have a plausible explanation for most of them.
typeof {};
// ->  "object"
typeof [];
// ->  "object"
...
typeof "abc";
// ->  "string"
"abc".length; // A primitive with properties?
// ->  3
typeof (new String("abc"));
// ->  "object"
typeof (new String("abc")).toString;
// ->  "function"
typeof (new String("abc")).toString();
// ->  "string"
typeof (new String("abc")).toString().length;
// ->  "number"
typeof undefined;
// "undefined"
void 0;
...
-1 * 10,000,000;
// ->  0
1/0;     // In math, this is undefined. No number satisfies. No real number times zero equals one.
// ->  Infinity
0/0;     // In math, this is undefined. Any number satisfies. Any real number times zero equals zero.
// ->  NaN           -- `NaN` stands for "not a number"
typeof Number.NEGATIVE_INFINITY;
// ->  "number"     -- Apologies to any mathemeticians among us
1.7976931348623158079372e308;
// -> 1.7976931348623157e+308     // Okay to copy-paste these numbers
1.7976931348623158079373e308;
// ->  Infinity
Number.POSITIVE_INFINITY-1;
// ->  Infinity
Number.POSITIVE_INFINITY - Number.POSITIVE_INFINITY;
// ->  NaN           -- `Mathemeticians approve. NaN stands for "not a number"
...
// Don't exepect to understand all of those lines yet. Do expect to figure some of
// them out. They are there to accelerate your learning by mixing in a touch of the
// unfamiliar. To be a success as an engineer you must be comfortable not understanding
// everything you see, and continuing to further your knowledge and productivity anyway.
// Enjoy any confusion. There's plenty more where that came from!

// And don't panic. You're already a junior-master JavaScript engineer!
